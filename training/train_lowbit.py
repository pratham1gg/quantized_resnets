...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train ResNet-18 on low-bit ImageNet-100")
    p.add_argument("--data",           default="/home/pf4636/imagenet")
    p.add_argument("--input-bits",     required=True, type=int, choices=[1, 2, 4],
                   help="Input image bit depth (1, 2, or 4)")
    ...
    p.add_argument("--best-path",      default=None, type=str)
...
def get_dataloaders(args: argparse.Namespace):
    ...
    quantize = Quantize01(args.input_bits)
...
if __name__ == "__main__":
    ...
    print(f"[Input]  {bits}-bit quantized images")
