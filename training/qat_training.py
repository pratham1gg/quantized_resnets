...
BEST_CHECKPOINT_PATH = ROOT / "training" / "checkpoints" / "fp32" / "seed_42" / "best.pth"
DEFAULT_CHECKPOINT_DIR = ROOT / "training" / "checkpoints" / "qat"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="ModelOpt QAT — INT8")
    p.add_argument("--precision",       default="int8", choices=["int8"],
